...
/**
 * This class validates a test PX XML file against proteomexchange web service, which should not return any errors.
 *
 * @author Florian Reisinger
 */
public class ValidateMessageWithPXService {
