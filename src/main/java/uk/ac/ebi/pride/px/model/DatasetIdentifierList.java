...
public class DatasetIdentifierList
    extends PXObject
    implements Serializable
{
    ...
    protected List<DatasetIdentifier> datasetIdentifier;
     ...
     * 
     */
    public List<DatasetIdentifier> getDatasetIdentifier() {
        if (datasetIdentifier == null) {
            datasetIdentifier = new ArrayList<DatasetIdentifier>();
        }
