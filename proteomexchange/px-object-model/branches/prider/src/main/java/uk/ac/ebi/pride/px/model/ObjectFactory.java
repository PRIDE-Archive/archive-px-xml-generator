 ...
 * generated in the uk.ac.ebi.pride.px.model package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: uk.ac.ebi.pride.px.model
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ProteomeXchangeDataset }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "ProteomeXchangeDataset")
    public JAXBElement<ProteomeXchangeDataset> createProteomeXchangeDataset(ProteomeXchangeDataset value) {
        return new JAXBElement<ProteomeXchangeDataset>(_ProteomeXchangeDataset_QNAME, ProteomeXchangeDataset.class, null, value);
    }
